...
├── results/
│   ├── csv/                  # Values reported in the manuscript
│   └── visualizations/       # Outputs produced by local runs
├── tests/                    # Unit tests
...
No software license is automatically granted by this scaffold. Review institutional, co-author, model, and dataset obligations, then add an approved `LICENSE` file before public release. See [LICENSE_NOTICE.md](LICENSE_NOTICE.md).
